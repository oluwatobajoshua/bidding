      ...
      <div class="box box-solid">
        ...
        <div class="box-body">
          <dl class="dl-horizontal">
            ...
            <dd><?= h($physicalPosture->name) ?></dd>
            <dt scope="row"><?= __('Id') ?></dt>
            <dd><?= $this->Number->format($physicalPosture->id) ?></dd>
          </dl>
        </div>
      </div>
    </div>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box box-solid">
        ...
        <!-- /.box-header -->
        <div class="box-body">
          <?php if (!empty($physicalPosture->employees)): ?>
          <table class="table table-hover">
              ...
              <?php foreach ($physicalPosture->employees as $employees): ?>
              <tr>
