      ...
      <div class="box box-solid">
        ...
        <div class="box-body">
          <dl class="dl-horizontal">
            ...
            <dd><?= $this->Number->format($location->id) ?></dd>
            <dt scope="row"><?= __('Date') ?></dt>
            <dd><?= h($location->date) ?></dd>
          </dl>
        </div>
      </div>
    </div>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box box-solid">
        ...
        <!-- /.box-header -->
        <div class="box-body">
          <?php if (!empty($location->addresses)): ?>
          <table class="table table-hover">
              ...
              <?php foreach ($location->addresses as $addresses): ?>
              <tr>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box box-solid">
        ...
        <!-- /.box-header -->
        <div class="box-body">
          <?php if (!empty($location->employees)): ?>
          <table class="table table-hover">
              <tr>
                    <th scope="col"><?= __('Id') ?></th>
              ...
              <?php foreach ($location->employees as $employees): ?>
              <tr>
